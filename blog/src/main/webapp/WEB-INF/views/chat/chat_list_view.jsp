...
<div class="container display-4 mt-5 mb-5">
	...
	<ul class="list-group">
		<c:forEach var="chatRoom" items="${chatRoomList }">
			...
			<li onclick="location.href='/chat/chatpage?chat_userno=${chatRoom.getMatchedUserNo()}'" class="list-group-item d-flex justify-content-between align-items-center">${chatRoom.getMatchedUserName() }<c:if test="${chatRoom.getRemainSawCnt() > 0}">
